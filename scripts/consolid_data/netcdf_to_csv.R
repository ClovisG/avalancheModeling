...
nc_to_csv<-function(ncin) {
  ...
  csv_name <- "test.csv" # TODO : find the right name
...
# open a netcdf file 
ncin <- open.nc("../data/forecast/adaptor.mars.internal-1552154124.7698312-30208-13-7fa26858-6cdf-4628-903f-11fbc0e6b1bb.nc")
